...
public:
  ...
  Image(EngineContext &context, const std::string &name, uint32_t color,
        VkFormat format = VK_FORMAT_R8G8B8A8_SRGB);
  Image(EngineContext& context, const std::string& name, int w, int h, void* data, VkFormat format = VK_FORMAT_R8G8B8A8_SRGB);
