...
#include "../vkh/systems/hud/text.hpp"
#include "rectImg.hpp"
#include "text.hpp"

namespace UI {
FilePicker::FilePicker(vkh::hud::View &view, Element *parent,
                       glm::vec2 position, glm::vec2 size, Mode mode)
    : mode{mode}, Element(view, parent, position, size) {
  addChild<RectImg>(glm::vec2{}, glm::vec2{1.f}, 0);
  list = addChild<Text>(glm::vec2{0.f, vkh::TextSys::glyphRange.maxSizeY});
