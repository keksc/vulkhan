...
public:
  Canvas(vkh::hud::View &view, Element *parent, glm::vec2 position,
...
private:
  ...
  std::shared_ptr<Text> modeText;
  std::shared_ptr<RectImg> modeBg;
  std::shared_ptr<EmptyRect> selectIndicator;
